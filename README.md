# Simple Task Management Board :wave: :v:
...
1. Backend (Express) dan Frontend (React) sepenuhnya terpisah.

2. Frontend disajikan menggunakan Nginx dengan multi-stage build untuk image Docker yang ringan dan aman.

3. Nginx berfungsi sebagai reverse proxy untuk menangani permintaan API ke backend.

4. Persistensi Data: Data database tetap aman dan tersimpan di Docker Volume, bahkan setelah container di-restart.
